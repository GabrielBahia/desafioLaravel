    ...
    <div class="card-info-style">
        <div class="infos-style">
            ...
            <div class="area-btn-voltar"> 
                <a href="{{ route('users.index') }}" class="btn btn-lg botao1-2 px-2 mt-3 btn-voltar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
